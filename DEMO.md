...
## 第四幕：Founder 压轴（~40 秒，立意拔高）
- 绿色胜利后别急着结束——**🧭 Founder 阶段滑出**：
  "刚才拼命杀它的四个评委，现在转为它辩护。" 指 Founder's Brief：
  为什么它赢（带判例）、机遇、风险、**你投入什么、几个月后拿到什么**。
- 指 Growth Backlog："Darwin 还把接下来 30 天的仗排好了——每天 2 篇博客共 20 篇，
  选题一半来自产品、一半来自**此刻的 HN 热点**。注意每个任务都带一个可证伪的假设：
  发完 20 篇，搜索展现量 +1000。**每个任务都是下一个赌注**——这就是 Darwin 的进化论：
  下注、测量、突变，永不停止。"
